      ...
      <div class="max-w-xl mx-auto px-4 py-6">
        ...
        @if (buscado() && !buscando() && resultados().length === 0) {
          <div style="background:#18181b; border:1px solid #27272a; border-radius:16px; padding:32px"
            ...
            <p class="text-zinc-600 text-xs mt-1">Intenta con otro nombre o pregunta al administrador</p>
          </div>
        }
        ...
        @if (clienteSeleccionado()) {
          <div>
            ...
            <div style="background: linear-gradient(135deg, #1a1040, #18181b); border:1px solid #3730a3; border-radius:20px; padding:24px"
                 class="mb-4">
              <p class="text-indigo-300 text-xs font-semibold uppercase tracking-widest mb-1">
                {{ clienteSeleccionado()!.nombre }}
              </p>
              <div class="flex items-end justify-between mt-2">
                <div>
                  <p class="text-zinc-400 text-xs">Tu saldo actual</p>
            ...
            <!-- Historial -->
            <div style="background:#18181b; border:1px solid #27272a; border-radius:16px; padding:20px">
              <h3 class="text-white font-semibold text-sm mb-4">Historial de movimientos</h3>

              @if (cargandoMovs()) {
                <div class="text-center py-8 text-zinc-500 text-sm">
                  <i class="pi pi-spinner pi-spin block text-2xl mb-2"></i>
                  Cargando...
                </div>
                    ...
                    <div class="ml-3 text-right shrink-0">
                      ...
                      @if (m.foto_url) {
                        <a [href]="m.foto_url" target="_blank"
                           style="color:#818cf8" class="text-xs hover:underline">
                          Ver foto
                        </a>
                      }
                    </div>
